 ...
 */
class ChartTextMarker extends ChartMarker {
     ...
     * - ChartTextMarker::FLAG
     * - ChartTextMarker::TEXT
     * - ChartTextMarker::ANNOTATION
     * - ChartTextMarker::VALUE
     * 
     * @param $text (string)
...
//@}
    ...
    public function setPlacement($horizontal_placement = null, $vertical_placement = null, $horizontal_offset = null, $vertical_offset = null, $bar_relative_placement = null) {
    ...
    public function compute($index, $chart_type = null) {
        ...
        $str .= sprintf(
                ',%s,%d,%s,%s', $this->color, $index, $points, $this->size
        );
