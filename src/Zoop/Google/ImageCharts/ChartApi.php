 ...
 *
 * This class implement basic features to query  Chart API using GET or
...
class ChartApi {
    ...
    /**
     * @name Function to query  Chart API
     */
//@{
    ...
    public function setQueryMethod($method) {
        if ($method !== self::POST && $method !== self::GET)
            throw new Exception(sprintf(
                    'Query method must be either Chart::POST or Chart::GET, "%s" given.', $method
            ));
     ...
     *
     * Use this method if you need to link 's URL directly, or if you
    ...
    /**
     * Return an HTML img tag with 's URL.
     *
    ...
    public function toHtml() {
        $str = sprintf(
                '<img src="%s" alt="" />', $this->getUrl()
        );
        return $str;
    }

    /**
     * Query  Chart and returns the image.
     *
     * @see setQueryMethod
     *
     * @return binary image
