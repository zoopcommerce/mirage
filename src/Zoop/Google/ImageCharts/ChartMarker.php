 ...
 *
 * Marker implementation in  Chart API is quite complex. There are many types
 ...
 * its own class, that extends ChartMarker.
 *
 * To display a marker, you need to set a data serie using setData() function.
 * A data serie is a ChartData object. It contains points used by the 
 * marker. You can provides an existing data serie (i.e. a data serie that has been
 * or will be added to the chart with Chart::addData()) or a new data serie.
 * In this case, the data serie will be hidden. Please refer to  Chart API
 * documentation about compound chart for further information.
 */
abstract class ChartMarker {

    /**
     * @var ChartData Will hold the data serie.
     */
    protected $data = null;
