 ...
 * - height
 *
 * Then you need to add data to that chart using ChartData class.
 *
 * Depending on the type of chart, you can also add one or more axis using ChartAxis class.
 *
...
class Chart extends ChartApi
{
	...
	/**
	 * List of all data series (ChartData)
	 */
	...
	/**
	 * List of all axes (ChartAxis)
	 */
	protected $axes = array();

	/**
	 * List of all markers (ChartMarker) @c chm parameter
	 */
	protected $markers = array();

	/**
	 * List of dynamic markers (chartIcon). @c chem parameter
	 */
	 ...
	 * Default is Chart::TEXT (basic text format).
	 * @since 0.5
	 */
	 ...
	 *
	 * @param $axis (ChartAxis)
	 * @see ChartAxis
	 */
	public function addAxis(ChartAxis $axis)
	{
		$this->axes[] = $axis;
	 ...
	 *
	 * @param $marker (ChartMarker)
	 * @see ChartShapeMarker, ChartTextMarker, ChartLineMarker
	 * @return $this
	 */
	public function addMarker(ChartMarker $marker)
	{
		$this->markers[] = $marker;
	 ...
	 * 
	 * @param $marker (ChartIcon)
	 * @return $this
	 */
	public function addDynamicMarker(ChartIcon $marker)
	{
...
//@{
	 ...
	 *
	 * Autoscaling is a feature provided by this library. Because  Chart
...
//@{
	 ...
	 * if the  Chart API evolves, this library will still works. However,
	 ...
	 *   (read  Chart Documentation for details).
	 * @return $this
	 */
	 ...
	 *   separated by commas (read  Chart Documentation for details).
	 * @return $this
	 */
...
//@{
	 ...
	 * - Chart::BACKGROUND for the whole background
	 * - Chart::CHART_AREA for only the chart area background
	 * @return $this
	 */
